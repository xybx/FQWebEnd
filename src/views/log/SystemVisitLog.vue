  ...
  <div class='container'>
    <div >
      <el-row :gutter='20'>
        ...
        <el-col :span='3'>
          <div class='grid-content bg-purple'>
            <el-select v-model='queryParam.type' clearable placeholder='请选择模块'>
              <el-option
    ...
    <el-table style='font-size: 15px' :data='tableData' border class='table' ref='multipleTable'
      ...
      <el-table-column prop='type' label='模块' align='center'></el-table-column>
...
<script>
import {queryPageApi} from '@/api/log/SystemVisitLog-api'
export default {
  name: 'systemVisitLog',
  data() {
    return {
