<template>
    ...
    <el-container>
        ...
        <el-main>
            <!-- 按钮集 -->
            <div class="btn">
                <el-button class="transimit" @click="transimit">转已会商</el-button>
        ...
        <!-- 编辑项目弹窗 -->
        <el-dialog title="编辑项目" :visible.sync="editDialogVisible" width="35%" custom-class="set-dialog"
            ...
            <el-form ref="form" :model="form" label-width="100px">
                ...
                <el-form-item label="三维模型">
                    <el-select v-model="form.kind" placeholder="请选择三维模型" >
                        <el-option v-for="item in mapTypes" :key="item.pid" :label="item.label" :value="item.kind"></el-option>
                    </el-select>
...
<script type="module">
export { default } from '@/views/projectManage/js/discussing';
</script>

<style scoped lang="scss">
@import '@/views/projectManage/style/discussing.scss';
</style>
