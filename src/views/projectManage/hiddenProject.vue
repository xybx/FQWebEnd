    ...
    <el-container>
        ...
        <el-main>
            ...
            <div class="btn">
                ...
                <el-button @click="transimit">转已会商</el-button>
                <el-button @click="repeal">隐藏项目</el-button> -->
            </div>
            <!-- 按钮集 -->
        ...
        <el-dialog title="编辑项目" :visible.sync="editDialogVisible" width="35%" custom-class="set-dialog"
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <!-- <el-button @click="handleDesign">设计汇演</el-button> -->
            </span>
        </el-dialog>
        <!-- 编辑项目弹窗 -->
    </el-container>
...
<script type="module">
export { default } from '@/views/projectManage/js/hiddenProject';
</script>

<style scoped lang="scss">
@import '@/views/projectManage/style/hiddenProject.scss';
</style>
