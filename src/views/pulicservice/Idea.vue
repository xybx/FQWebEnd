...
<template>
    <div class="container">
        ...
        <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
            ...
            <el-table-column label="操作" width="120" align="center">
                <template slot-scope="scope">
                    <el-button type="text" icon="el-icon-edit" size="mini" class="blue"
                 ...
                 -->
                    ...
                    <el-button type="text" icon="el-icon-setting" class="green" @click="handleDelete(scope.row)"
                        v-if="scope.row.STATUS == 0">恢复</el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <!-- 新增/编辑弹窗 -->
        <el-dialog :title="setTitle" :visible.sync="setVisible" width="40%" custom-class="set-dialog"
            ...
            <el-form ref="setForm" :model="setForm" label-width="auto" class="set-form" :rules="setFormRules">
                ...
                <el-form-item label="内容" prop="CONTENT">
                    <quill-editor class="ql-editor" v-model="setForm.CONTENT" ref="myQuillEditor" :options="editorOption">
                    </quill-editor>
                </el-form-item>
            </el-form>
