    ...
    <el-container>
      <el-main>
        <div class='loginbox'>
          <el-row>
            <el-col :span='12'>
              <div class='title'><img src='../assets/login/fqcimTitle.png' alt=''></div>
                ...
                <div class='text item'>
                  ...
                  <el-form ref='loginForm' :model='loginForm' label-width='auto' class='ms-content'
                    ...
                    <el-form-item label='' prop='phoneNum'>
                      <el-input type='phoneNum' placeholder='请输入账号'
                      ...
                      <el-col>
                        <el-form-item prop='vcCode' style='width: 60%; float: left'>
                          <el-input placeholder='请输入验证码'
                                    v-model.trim='loginForm.vcCode' @keyup.enter.native='submitForm()'
                                    prefix-icon='el-icon-key'>
                          </el-input>
                        </el-form-item>
                        <div @click='getVcCode()'>
                          <el-image style=' border: 1px solid #dcdfe6' :src='codeUrl' fit='fill' />
                        </div>
                      </el-col>
                    </el-row>
